...
import com.example.yunwen.testdemo1022.BuildConfig;
import com.example.yunwen.testdemo1022.base.BaseApplication;
...
//        XHttpSDK.setBaseUrl();  //设置网络请求的基础地址
        XHttp.getInstance().setBaseUrl("http://v.juhe.cn/");
