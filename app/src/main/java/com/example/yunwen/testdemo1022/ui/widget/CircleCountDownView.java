...
public class CircleCountDownView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        padding = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_padding, SizeUtils.dp2px(5));
        ...
        if (borderWidth > 0) {
            ...
            if (showProgress) {
                ...
                processBlurMaskRadius = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_processBlurMaskRadius, SizeUtils.dp2px(5));
            }
        }
        ...
        valueTextPaint.setTextSize(typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_valueTextSize, SizeUtils.dp2px(13)));
